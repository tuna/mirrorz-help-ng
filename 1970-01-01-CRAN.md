...
<div class="z-wrap"><form class="z-form" onchange="form_update(event)" onsubmit="return false"><div><label for="5082effe" title>操作系统版本</label><select id="5082effe" name="release" title><option value="bullseye">Debian 11 (bullseye)</option><option value="buster">Debian 10 (buster)</option><option value="stretch">Debian 9 (stretch) (EOL)</option><option value="bookworm">Debian 8 (jessie) (EOL)</option><option value="jammy">Ubuntu 22.04 LTS (jammy)</option><option value="focal">Ubuntu 20.04 LTS (focal)</option><option value="bionic">Ubuntu 18.04 LTS (bionic)</option><option value="xenial">Ubuntu 16.04 LTS (xenial) (EOL)</option></select></div><div><label for="a62e8f1c" title>CRAN 版本</label><select id="a62e8f1c" name="version" title><option value="cran40">cran40</option><option value="cran35">cran35</option><option value="cran34">cran34</option></select></div></form><pre class="z-code"></pre></div><tmpl z-input="release version" z-path="/etc/apt/sources.list.d/r-mirror.list">
