...
<div class="z-wrap"><form class="z-form" onchange="form_update(event)" onsubmit="return false"><div><label for="2b70d97b" title>操作系统版本</label><select id="2b70d97b" name="release" title><option value="bullseye">Debian 11 (bullseye)</option><option value="buster">Debian 10 (buster)</option><option value="stretch">Debian 9 (stretch) (EOL)</option><option value="bookworm">Debian 8 (jessie) (EOL)</option><option value="jammy">Ubuntu 22.04 LTS (jammy)</option><option value="focal">Ubuntu 20.04 LTS (focal)</option><option value="bionic">Ubuntu 18.04 LTS (bionic)</option><option value="xenial">Ubuntu 16.04 LTS (xenial) (EOL)</option></select></div><div><label for="76503564" title>CRAN 版本</label><select id="76503564" name="version" title><option value="cran40">cran40</option><option value="cran35">cran35</option><option value="cran34">cran34</option></select></div></form><pre class="z-code"></pre></div><tmpl z-input="release version" z-path="/etc/apt/sources.list.d/r-mirror.list">
